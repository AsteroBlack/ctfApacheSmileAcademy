...
@Component({
  selector: 'app-transfert-corbeille',
  templateUrl: './transfert-corbeille.component.html',
  styleUrls: ['./transfert-corbeille.component.scss']
})
export class TransfertCorbeilleComponent implements OnInit {
