...
@Component({
  selector: 'app-mise-en-machine-de-masse',
  templateUrl: './mise-en-machine-de-masse.component.html',
  styleUrls: ['./mise-en-machine-de-masse.component.scss']
})
export class MiseEnMachineDeMasseComponent implements OnInit {
  ...
  setFileData(data?) {
    ...
    request.append('date', moment().format('DD/MM/YYYY HH:mm:ss'));
    request.append('identifiant','');
    request.append('idStatus', '3');
