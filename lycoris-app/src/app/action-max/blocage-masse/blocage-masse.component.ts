...
@Component({
  selector: 'app-blocage-masse',
  templateUrl: './blocage-masse.component.html',
  styleUrls: ['./blocage-masse.component.scss']
})
export class BlocageMasseComponent implements OnInit {
