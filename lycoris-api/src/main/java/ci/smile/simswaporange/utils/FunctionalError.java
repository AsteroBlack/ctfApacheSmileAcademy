...
public class FunctionalError {
	...
	public Status SUCCESS_VALIDATED(String message, Locale locale) {
		status.setCode(StatusCode.SUCCESS);
		status.setMessage(messageSource.getMessage("StatusMessage.VALIDATED", new Object[] {}, locale) + ": " + message);
		return status;
	}
	...
	public Status FAILED(String message, Locale locale) {
		status.setCode(StatusCode.FAILED);
		status.setMessage(messageSource.getMessage("StatusMessage.FAILED", new Object[] {}, locale) + ": " + message);
		return status;
	}
	...
	public Status DATA_ALREADY(String message, Locale locale) {
		status.setCode(StatusCode.FUNC_DATA_ALREADY);
		status.setMessage(messageSource.getMessage("StatusMessage.FUNC_ALREADY", new Object[] {}, locale) + ": " + message);
		return status;
	}
	...
	public Status ACCESS_DENIED(String message, Locale locale) {
		...
		status.setMessage(
				messageSource.getMessage("StatusMessage.FUNC_ACCESS_DENIED", new Object[] {}, locale) + "" + message);
		return status;
	}
